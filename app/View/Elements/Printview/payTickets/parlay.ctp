...
$count = 1;
    ...
    <div id="mainTicket_<?=$generalInfo["ticketInfo"]["row1"]["TicketNumber"]?>" class="col-md-4 center-block containerP">
        ...
        <div id="firstb">
            <p class="center"><?=$generalInfo["ticketInfo"]["row1"]["CustomerID"]?></p>
        </div>
        ...
        <div id="tickettotals">
            <p>Cuota <span class="alignright"><b><?= round($cuota, 2) ?></b></span></p>
            <p>Cantidad <span class="alignright"><b><?php echo $currency; ?> <?= round($ticket["Risk"], 2) ?></b></span></p>
            <p>Gane<span class="alignright"><?php echo $currency; ?><?= round($ticket["ToWinAmount"], 2) ?></span></p>
            <p>Retencion: <span class="alignright" style="color: red;font-weight: bold"><?php echo $currency; ?>&nbsp;-<?= $retention?>%**</span></p>
            <p style="border:none;">Pago Total <span class="alignright"><?php echo $currency; ?> <?= round($ticket["ToWinAmount"]+$ticket["Risk"], 2) ?></span></p>
        </div>
        <hr class="line" />
        <center>
