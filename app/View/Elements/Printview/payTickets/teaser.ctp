...
$count = 1;
    ...
    <h3 class="center">Pago de Apuesta</h3>
    ...
    <div id="mainTicket_<?=$generalInfo["ticketInfo"]["row1"]["TicketNumber"]?>" class="col-md-4 center-block containerP">
        ...
        <div id="tickettotals">
            ...
            <p style="border:none;">Pago Total <span class="alignright"><?php echo $currency; ?> <?= round($ticket["Risk"]+$ticket["ToWinAmount"], 2) ?></span></p>
        </div>
        <hr class="line" />
        <center>
