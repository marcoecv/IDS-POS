...
//    $("#sp_search").keyup(function (){
//        searchFlag=false;
//        if($("#sp_search").val()===""){
//            var checks=$(".leftMenuCheckBox");
...
//    });
    ...
    $("#sp_search_button").click(function (){
        var info=$("#sp_search").val();
        var array1=info.split("@");
        var gameNum=array1[1];
        var array2=array1[0].split("*");
        
        var Sport=array2[0];
        var subSport=array2[1];
        var League=array2[2];
         var parametros = {
             sport: Sport,
             league: subSport,
...
function setEvents(){
    ...
    $(".addToBetslip").click(!($(this).attr("class").includes("blocked"))?addToBetslipClick:"");
}
