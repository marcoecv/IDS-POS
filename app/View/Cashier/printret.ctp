...
<div id="mainTicket_123" class="col-md-4 center-block">
    <div class="panel panel-primary ">
        ...
        <div class="row">
            <center><h2><b>Recibo de Retiro</b></h2></center>
        </div>
        <ul class="list-group">
            ...
            <li class="list-group-item"><strong>Transaccion: <?= $doc ?></strong></li>
            <li class="list-group-item"><strong>Cuenta: <?= $detail->player ?></strong></li>
            <li class="list-group-item"><b>Descripcion:</b> Retiro de Cuenta.</li>
        </ul>
        <br>

        <h2><small>Total Retiro: </small><b>$<?= $monto ?></b></h2>
