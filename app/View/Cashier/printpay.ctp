...
<div id="printButton" class="panel-body text-center">
    <button class="btn btn-md btn-default" style="width: 100%;background: rgb(255, 223, 27);height: 70px;font-size: 28px; margin-bottom: 12px;"
...
<div id="mainTicket_123" class="col-md-4 center-block">
    <div class="panel panel-primary ">
        ...
        <div class="row">
            <center><h2><b>Recibo de Pago</b></h2></center>
        </div>
        <ul class="list-group">
            <li class="list-group-item">Fecha de Emision: <?= date("Y-m-d H:i:s") ?></li>
            <li class="list-group-item">Usuario: <b><?= $authUser['username'] ?></b> Caja: <?= $authUser['caja'] ?></li>
        </ul>
        <br>
        ...
        foreach ($ticketsPay as $ticket) {
            ...
            ?>
            <ul class="list-group">
                <li class="list-group-item"><strong>Ticket: #<?= $ticket->id ?></strong></li>
                <li class="list-group-item">Fecha de Emision: <?= $ticket->date ?></li>
                <li class="list-group-item"><b>Descripcion:</b> <?= $ticket->desc ?></li>
                <li class="list-group-item">Riesgo: <b><?= $ticket->risk ?></b>&nbsp;&nbsp; Gane:
                    <b><?= $ticket->won ?></b></li>
                <li class="list-group-item" style="font-size: 18px;"><b>A Pagar:&nbsp;&nbsp;</b><?= $ticket->monto ?>
                </li>
        ...
        <h2><small>Total a Pagar: </small><b>$<?= $monto ?></b></h2>
...
<center>
    <span class="pv_footertxt">Gracias por elegirnos, recuerda ingresar en <b>www.<?=$siteDesc?>.com</b>, donde encontraras la mayor variedad de
        ofertas y productos para disfrutar donde y cuando quiera, con solo utilizar su numero de cuenta y su clave.</span>
    <br/>
    <b>*************************************</b><br/>
            <span class="pv_footertxt" style="font-size: 24px;">
                www.<?=$siteDesc?>.com
            </span>
</center>
<div id="printButton" class="panel-body text-center">
