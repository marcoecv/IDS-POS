...
foreach ($generalInfo["ticketInfo"] as $ticket) {
    ...
    <div id="mainTicket_<?= $ticket["TicketNumber"] ?>" class="col-md-4 center-block containerP">
        ...
        <div id="firstb">
            <p class="center"><?=$ticket["CustomerID"]?></p>
        </div>
        ...
        <div id="thirdb">
            <p class="center"><?= $ticket["BetType"] ?></p>
        </div>
        ...
        <hr class="line" />
        <center>
            <div id="codeDiv_<?= $ticket["TicketNumber"] ?>" class="panel-body text-center" style="width: 100%">
            ...
            <div id="disclaimer">
                ...
                if ($ticketType == "1") {
                    ...
                    <p class="center"><b>Pagadero al portador</b><br/>
